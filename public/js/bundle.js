...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYmFyYWtiaCIsImEiOiJjbGh1Z211bmowN3ZpM2ZwbzF0MW16Y2pvIn0.k-mv3hEqVxWeLNsBaNvQFw';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/barakbh/clhugwvlg004301qsgtxhgajv',
    scrollZoom: false
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(data, type) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          url = type === 'password' ? 'localhost:3000/api/v1/users/updateMyPassword' : 'localhost:3000/api/v1/users/updateMe';
          _context.next = 4;
          return (0, _axios.default)({
            method: 'PATCH',
            url: url,
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; } /* eslint-disable */
var stripe = Stripe('pk_test_51NAFD0FH4NwTSoUGp8tcbJxjwBKtR0qFZ1xGB2HoXRHXa8h29TrS1baVMar6X6ituP8s60UVxv5xJ6NIxleEP7UH00OcJXwJ6F');
