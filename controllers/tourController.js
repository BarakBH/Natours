...
// After making handleFactory controller we made global handling that takes a module and returns the action.
...
exports.getToursWithin = catchAsync(async (req, res, next) => {
  ...
  if (!lat || !lng) {
    next(new AppError('Please provide latitue and longitude in the format lat,lng.', 400));
  }
